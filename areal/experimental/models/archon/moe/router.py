...
class TokenChoiceTopKRouter(nn.Module):
    ...
    def forward(
        ...
        # Going through self.gate() (module __call__) ensures ReplicateParallel
        # DTensor hooks fire. RouterGateLinear.forward() calls RouterGatingLinearFunction
        # when router_dtype is set, preserving memory-efficient bf16 activation storage.
        scores = self.gate(x)
